defmodule L2E.NPC.SpawnTable do
  ...
  defp load_spawn_defs do
    ...
    if xml_defs == [] do
      Logger.info(
        "[SpawnTable] No XML spawn files found — using hardcoded Talking Island fallback"
      )
  ...
  defp hardcoded_spawn_defs do
    [
      # NPC Village
      {30008, -84318, 243_637, -3729, 0, 60_000},
      {30006, -83826, 244_043, -3729, 0, 60_000},
      {30059, -82827, 242_741, -3729, 0, 60_000},
      {30131, -82943, 243_087, -3729, 0, 60_000},
      {30017, -83993, 243_445, -3729, 0, 60_000},
      # Monsters
      {20446, -83568, 241_898, -3729, 0, 30_000},
      {20446, -84100, 241_500, -3729, 0, 30_000},
      {20446, -85000, 242_000, -3729, 0, 30_000},
      {20447, -86000, 243_000, -3729, 0, 35_000},
      {20447, -86500, 244_000, -3729, 0, 35_000},
      {20456, -87000, 244_500, -3729, 0, 40_000},
      {20456, -87500, 243_500, -3729, 0, 40_000}
    ]
  end
