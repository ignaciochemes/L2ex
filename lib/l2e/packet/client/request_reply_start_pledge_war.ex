defmodule L2E.Packet.Client.RequestReplyStartPledgeWar do
  @moduledoc """
  RequestReplyStartPledgeWar — defender accepts the war declaration.
  NOTE: Opcode 0x89 conflicts with RequestFishing in the current decoder;
