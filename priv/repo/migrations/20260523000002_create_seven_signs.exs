defmodule L2E.Repo.Migrations.CreateSevenSigns do
  ...
  def change do
    ...
    create table(:seven_signs_players) do
      ...
      # "dawn" | "dusk" | "none"
      add(:cabal, :string, size: 8, default: "none")
      add(:contribution_score, :integer, default: 0)
      # Ancient Adena stones
      add(:bluestone_count, :integer, default: 0)
      add(:greenstone_count, :integer, default: 0)
      add(:redstone_count, :integer, default: 0)
      add(:accumulated_adena, :bigint, default: 0)
      # period number when registered
      add(:registered_period, :integer, default: 0)
    end
    ...
    create table(:seven_signs_state) do
      ...
      add(:current_period, :integer, default: 1)
      ...
      # "dawn" | "dusk" | "none"
      add(:seal_avarice_owner, :string, size: 8, default: "none")
